...
int main(int argc, char* argv[])
{
    ...
    if (errmsg.size())
    {
        ...
        log("\nText-based desktop environment " + text{ app::shared::version } +
            ...
            "\n  Syntax:"
            "\n"
            "\n    " + os::process::binary<true>() + " [ -c <file> ] [ -p <name> ] [ -i | -u ] [ -q ] [ -l | -m | -d | -s | -r [<app> [<args...>]] ]"
            "\n"
            "\n  Options:"
            "\n"
            ...
            "\n        vtm"
            "\n"
            "\n    Run remote vtm desktop inside the current console via SSH:"
            "\n"
            ...
            "\n"
            "\n    Run an application remotely via SSH:"
            "\n"
