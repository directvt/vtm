...
/**
 * unidata.hpp autogenerated 2024-05-11 15:43:08.156087
 *
...
namespace netxs::unidata
{
    ...
    struct base
    {
        ...
        static constexpr auto offset_pack = std::to_array<si32>(
        {
            ...
            111, 68,145, -2, 68,146, -3, 68,147,-196, 68,-272, 95,-254,  0, -2,
             69
        });
        ...
        static constexpr auto ucspec = std::to_array<unidata>(
        {
            ...
            { widths::trid, gbreak::ext , cntrls::non_control            },  // 146
            { widths::quad, gbreak::ext , cntrls::non_control            },  // 147
        });
    };
