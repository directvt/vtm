...
/**
 * unidata.hpp autogenerated 2024-05-12 03:18:53.533714
 *
...
namespace netxs::unidata
{
    ...
    struct base
    {
        ...
        static constexpr auto offset_pack = std::to_array<si32>(
        {
            ...
            -75,107, -5, 69,-352,107,-80, 69,-32, 95,-96, 68,-128, 95,-34, 68,
            111,146,145,147,148,149,150,151,152,153,154,155,156,157, -2, 68,
            158,159,160,161,162,163,164,165,166,167,168,169,170,171, -2, 68,
            172,173,174,175,176,177,178,179,180,181,182,183,184,185, -2, 68,
            186,187,188,189,190,191,192,193,194,195,196,197,198,199, -2, 68,
            200,201,202,203,204,205,206,207,208,209,210,211,212,213, -2, 68,
            214,215,216,217,218,219,220,221,222,223,224,225,226,227, -2, 68,
            228,229,230,231,232,233,234,235,236,237,238,239,240,241, -2, 68,
            242,243,244,245,246,247,248,249,250,251,252,253,254,255, -2, 68,
            256,257,258,259,260,261,262,263,264,265,266,267,268,269, -2, 68,
            270,271,272,273,274,275,276,277,278,279,280,281,282,283, -2, 68,

            284,285,286,287,288,289,290,291,292,293,294,295,296,297, -2, 68,
            298,299,300,301,302,303,304,305,306,307,308,309,310,311, -2, 68,
            312,313,314,315,316,317,318,319,320,321,322,323,324,325, -2, 95,
            326,327,328,329,330,331,332,333,334,335,336,337,338,339,-256, 95,
            -254,  0, -2, 69
        });
        ...
        static constexpr auto ucspec = std::to_array<unidata>(
        {
            ...
            { widths::vs<11,10>, gbreak::ext , cntrls::non_control            },  // 146
            { widths::vs<21,10>, gbreak::ext , cntrls::non_control            },  // 147
            { widths::vs<21,20>, gbreak::ext , cntrls::non_control            },  // 148
            { widths::vs<31,00>, gbreak::ext , cntrls::non_control            },  // 149
            { widths::vs<31,10>, gbreak::ext , cntrls::non_control            },  // 150
            { widths::vs<31,20>, gbreak::ext , cntrls::non_control            },  // 151
            { widths::vs<31,30>, gbreak::ext , cntrls::non_control            },  // 152
            { widths::vs<41,00>, gbreak::ext , cntrls::non_control            },  // 153
            { widths::vs<41,10>, gbreak::ext , cntrls::non_control            },  // 154
            { widths::vs<41,20>, gbreak::ext , cntrls::non_control            },  // 155
            { widths::vs<41,30>, gbreak::ext , cntrls::non_control            },  // 156
            { widths::vs<41,40>, gbreak::ext , cntrls::non_control            },  // 157
            { widths::vs<11,01>, gbreak::ext , cntrls::non_control            },  // 158
            { widths::vs<11,11>, gbreak::ext , cntrls::non_control            },  // 159
            { widths::vs<21,01>, gbreak::ext , cntrls::non_control            },  // 160
            { widths::vs<21,11>, gbreak::ext , cntrls::non_control            },  // 161
            { widths::vs<21,21>, gbreak::ext , cntrls::non_control            },  // 162
            { widths::vs<31,01>, gbreak::ext , cntrls::non_control            },  // 163
            { widths::vs<31,11>, gbreak::ext , cntrls::non_control            },  // 164
            { widths::vs<31,21>, gbreak::ext , cntrls::non_control            },  // 165
            { widths::vs<31,31>, gbreak::ext , cntrls::non_control            },  // 166
            { widths::vs<41,01>, gbreak::ext , cntrls::non_control            },  // 167
            { widths::vs<41,11>, gbreak::ext , cntrls::non_control            },  // 168
            { widths::vs<41,21>, gbreak::ext , cntrls::non_control            },  // 169
            { widths::vs<41,31>, gbreak::ext , cntrls::non_control            },  // 170
            { widths::vs<41,41>, gbreak::ext , cntrls::non_control            },  // 171
            { widths::vs<12,00>, gbreak::ext , cntrls::non_control            },  // 172
            { widths::vs<12,10>, gbreak::ext , cntrls::non_control            },  // 173
            { widths::vs<22,00>, gbreak::ext , cntrls::non_control            },  // 174
            { widths::vs<22,10>, gbreak::ext , cntrls::non_control            },  // 175
            { widths::vs<22,20>, gbreak::ext , cntrls::non_control            },  // 176
            { widths::vs<32,00>, gbreak::ext , cntrls::non_control            },  // 177
            { widths::vs<32,10>, gbreak::ext , cntrls::non_control            },  // 178
            { widths::vs<32,20>, gbreak::ext , cntrls::non_control            },  // 179
            { widths::vs<32,30>, gbreak::ext , cntrls::non_control            },  // 180
            { widths::vs<42,00>, gbreak::ext , cntrls::non_control            },  // 181
            { widths::vs<42,10>, gbreak::ext , cntrls::non_control            },  // 182
            { widths::vs<42,20>, gbreak::ext , cntrls::non_control            },  // 183
            { widths::vs<42,30>, gbreak::ext , cntrls::non_control            },  // 184
            { widths::vs<42,40>, gbreak::ext , cntrls::non_control            },  // 185
            { widths::vs<12,01>, gbreak::ext , cntrls::non_control            },  // 186
            { widths::vs<12,11>, gbreak::ext , cntrls::non_control            },  // 187
            { widths::vs<22,01>, gbreak::ext , cntrls::non_control            },  // 188
            { widths::vs<22,11>, gbreak::ext , cntrls::non_control            },  // 189
            { widths::vs<22,21>, gbreak::ext , cntrls::non_control            },  // 190
            { widths::vs<32,01>, gbreak::ext , cntrls::non_control            },  // 191
            { widths::vs<32,11>, gbreak::ext , cntrls::non_control            },  // 192
            { widths::vs<32,21>, gbreak::ext , cntrls::non_control            },  // 193
            { widths::vs<32,31>, gbreak::ext , cntrls::non_control            },  // 194
            { widths::vs<42,01>, gbreak::ext , cntrls::non_control            },  // 195
            { widths::vs<42,11>, gbreak::ext , cntrls::non_control            },  // 196
            { widths::vs<42,21>, gbreak::ext , cntrls::non_control            },  // 197
            { widths::vs<42,31>, gbreak::ext , cntrls::non_control            },  // 198
            { widths::vs<42,41>, gbreak::ext , cntrls::non_control            },  // 199
            { widths::vs<12,02>, gbreak::ext , cntrls::non_control            },  // 200
            { widths::vs<12,12>, gbreak::ext , cntrls::non_control            },  // 201
            { widths::vs<22,02>, gbreak::ext , cntrls::non_control            },  // 202
            { widths::vs<22,12>, gbreak::ext , cntrls::non_control            },  // 203
            { widths::vs<22,22>, gbreak::ext , cntrls::non_control            },  // 204
            { widths::vs<32,02>, gbreak::ext , cntrls::non_control            },  // 205
            { widths::vs<32,12>, gbreak::ext , cntrls::non_control            },  // 206
            { widths::vs<32,22>, gbreak::ext , cntrls::non_control            },  // 207
            { widths::vs<32,32>, gbreak::ext , cntrls::non_control            },  // 208
            { widths::vs<42,02>, gbreak::ext , cntrls::non_control            },  // 209
            { widths::vs<42,12>, gbreak::ext , cntrls::non_control            },  // 210
            { widths::vs<42,22>, gbreak::ext , cntrls::non_control            },  // 211
            { widths::vs<42,32>, gbreak::ext , cntrls::non_control            },  // 212
            { widths::vs<42,42>, gbreak::ext , cntrls::non_control            },  // 213
            { widths::vs<13,00>, gbreak::ext , cntrls::non_control            },  // 214
            { widths::vs<13,10>, gbreak::ext , cntrls::non_control            },  // 215
            { widths::vs<23,00>, gbreak::ext , cntrls::non_control            },  // 216
            { widths::vs<23,10>, gbreak::ext , cntrls::non_control            },  // 217
            { widths::vs<23,20>, gbreak::ext , cntrls::non_control            },  // 218
            { widths::vs<33,00>, gbreak::ext , cntrls::non_control            },  // 219
            { widths::vs<33,10>, gbreak::ext , cntrls::non_control            },  // 220
            { widths::vs<33,20>, gbreak::ext , cntrls::non_control            },  // 221
            { widths::vs<33,30>, gbreak::ext , cntrls::non_control            },  // 222
            { widths::vs<43,00>, gbreak::ext , cntrls::non_control            },  // 223
            { widths::vs<43,10>, gbreak::ext , cntrls::non_control            },  // 224
            { widths::vs<43,20>, gbreak::ext , cntrls::non_control            },  // 225
            { widths::vs<43,30>, gbreak::ext , cntrls::non_control            },  // 226
            { widths::vs<43,40>, gbreak::ext , cntrls::non_control            },  // 227
            { widths::vs<13,01>, gbreak::ext , cntrls::non_control            },  // 228
            { widths::vs<13,11>, gbreak::ext , cntrls::non_control            },  // 229
            { widths::vs<23,01>, gbreak::ext , cntrls::non_control            },  // 230
            { widths::vs<23,11>, gbreak::ext , cntrls::non_control            },  // 231
            { widths::vs<23,21>, gbreak::ext , cntrls::non_control            },  // 232
            { widths::vs<33,01>, gbreak::ext , cntrls::non_control            },  // 233
            { widths::vs<33,11>, gbreak::ext , cntrls::non_control            },  // 234
            { widths::vs<33,21>, gbreak::ext , cntrls::non_control            },  // 235
            { widths::vs<33,31>, gbreak::ext , cntrls::non_control            },  // 236
            { widths::vs<43,01>, gbreak::ext , cntrls::non_control            },  // 237
            { widths::vs<43,11>, gbreak::ext , cntrls::non_control            },  // 238
            { widths::vs<43,21>, gbreak::ext , cntrls::non_control            },  // 239
            { widths::vs<43,31>, gbreak::ext , cntrls::non_control            },  // 240
            { widths::vs<43,41>, gbreak::ext , cntrls::non_control            },  // 241
            { widths::vs<13,02>, gbreak::ext , cntrls::non_control            },  // 242
            { widths::vs<13,12>, gbreak::ext , cntrls::non_control            },  // 243
            { widths::vs<23,02>, gbreak::ext , cntrls::non_control            },  // 244
            { widths::vs<23,12>, gbreak::ext , cntrls::non_control            },  // 245
            { widths::vs<23,22>, gbreak::ext , cntrls::non_control            },  // 246
            { widths::vs<33,02>, gbreak::ext , cntrls::non_control            },  // 247
            { widths::vs<33,12>, gbreak::ext , cntrls::non_control            },  // 248
            { widths::vs<33,22>, gbreak::ext , cntrls::non_control            },  // 249
            { widths::vs<33,32>, gbreak::ext , cntrls::non_control            },  // 250
            { widths::vs<43,02>, gbreak::ext , cntrls::non_control            },  // 251
            { widths::vs<43,12>, gbreak::ext , cntrls::non_control            },  // 252
            { widths::vs<43,22>, gbreak::ext , cntrls::non_control            },  // 253
            { widths::vs<43,32>, gbreak::ext , cntrls::non_control            },  // 254
            { widths::vs<43,42>, gbreak::ext , cntrls::non_control            },  // 255
            { widths::vs<13,03>, gbreak::ext , cntrls::non_control            },  // 256
            { widths::vs<13,13>, gbreak::ext , cntrls::non_control            },  // 257
            { widths::vs<23,03>, gbreak::ext , cntrls::non_control            },  // 258
            { widths::vs<23,13>, gbreak::ext , cntrls::non_control            },  // 259
            { widths::vs<23,23>, gbreak::ext , cntrls::non_control            },  // 260
            { widths::vs<33,03>, gbreak::ext , cntrls::non_control            },  // 261
            { widths::vs<33,13>, gbreak::ext , cntrls::non_control            },  // 262
            { widths::vs<33,23>, gbreak::ext , cntrls::non_control            },  // 263
            { widths::vs<33,33>, gbreak::ext , cntrls::non_control            },  // 264
            { widths::vs<43,03>, gbreak::ext , cntrls::non_control            },  // 265
            { widths::vs<43,13>, gbreak::ext , cntrls::non_control            },  // 266
            { widths::vs<43,23>, gbreak::ext , cntrls::non_control            },  // 267
            { widths::vs<43,33>, gbreak::ext , cntrls::non_control            },  // 268
            { widths::vs<43,43>, gbreak::ext , cntrls::non_control            },  // 269
            { widths::vs<14,00>, gbreak::ext , cntrls::non_control            },  // 270
            { widths::vs<14,10>, gbreak::ext , cntrls::non_control            },  // 271
            { widths::vs<24,00>, gbreak::ext , cntrls::non_control            },  // 272
            { widths::vs<24,10>, gbreak::ext , cntrls::non_control            },  // 273
            { widths::vs<24,20>, gbreak::ext , cntrls::non_control            },  // 274
            { widths::vs<34,00>, gbreak::ext , cntrls::non_control            },  // 275
            { widths::vs<34,10>, gbreak::ext , cntrls::non_control            },  // 276
            { widths::vs<34,20>, gbreak::ext , cntrls::non_control            },  // 277
            { widths::vs<34,30>, gbreak::ext , cntrls::non_control            },  // 278
            { widths::vs<44,00>, gbreak::ext , cntrls::non_control            },  // 279
            { widths::vs<44,10>, gbreak::ext , cntrls::non_control            },  // 280
            { widths::vs<44,20>, gbreak::ext , cntrls::non_control            },  // 281
            { widths::vs<44,30>, gbreak::ext , cntrls::non_control            },  // 282
            { widths::vs<44,40>, gbreak::ext , cntrls::non_control            },  // 283
            { widths::vs<14,01>, gbreak::ext , cntrls::non_control            },  // 284
            { widths::vs<14,11>, gbreak::ext , cntrls::non_control            },  // 285
            { widths::vs<24,01>, gbreak::ext , cntrls::non_control            },  // 286
            { widths::vs<24,11>, gbreak::ext , cntrls::non_control            },  // 287
            { widths::vs<24,21>, gbreak::ext , cntrls::non_control            },  // 288
            { widths::vs<34,01>, gbreak::ext , cntrls::non_control            },  // 289
            { widths::vs<34,11>, gbreak::ext , cntrls::non_control            },  // 290
            { widths::vs<34,21>, gbreak::ext , cntrls::non_control            },  // 291
            { widths::vs<34,31>, gbreak::ext , cntrls::non_control            },  // 292
            { widths::vs<44,01>, gbreak::ext , cntrls::non_control            },  // 293
            { widths::vs<44,11>, gbreak::ext , cntrls::non_control            },  // 294
            { widths::vs<44,21>, gbreak::ext , cntrls::non_control            },  // 295
            { widths::vs<44,31>, gbreak::ext , cntrls::non_control            },  // 296
            { widths::vs<44,41>, gbreak::ext , cntrls::non_control            },  // 297
            { widths::vs<14,02>, gbreak::ext , cntrls::non_control            },  // 298
            { widths::vs<14,12>, gbreak::ext , cntrls::non_control            },  // 299
            { widths::vs<24,02>, gbreak::ext , cntrls::non_control            },  // 300
            { widths::vs<24,12>, gbreak::ext , cntrls::non_control            },  // 301
            { widths::vs<24,22>, gbreak::ext , cntrls::non_control            },  // 302
            { widths::vs<34,02>, gbreak::ext , cntrls::non_control            },  // 303
            { widths::vs<34,12>, gbreak::ext , cntrls::non_control            },  // 304
            { widths::vs<34,22>, gbreak::ext , cntrls::non_control            },  // 305
            { widths::vs<34,32>, gbreak::ext , cntrls::non_control            },  // 306
            { widths::vs<44,02>, gbreak::ext , cntrls::non_control            },  // 307
            { widths::vs<44,12>, gbreak::ext , cntrls::non_control            },  // 308
            { widths::vs<44,22>, gbreak::ext , cntrls::non_control            },  // 309
            { widths::vs<44,32>, gbreak::ext , cntrls::non_control            },  // 310
            { widths::vs<44,42>, gbreak::ext , cntrls::non_control            },  // 311
            { widths::vs<14,03>, gbreak::ext , cntrls::non_control            },  // 312
            { widths::vs<14,13>, gbreak::ext , cntrls::non_control            },  // 313
            { widths::vs<24,03>, gbreak::ext , cntrls::non_control            },  // 314
            { widths::vs<24,13>, gbreak::ext , cntrls::non_control            },  // 315
            { widths::vs<24,23>, gbreak::ext , cntrls::non_control            },  // 316
            { widths::vs<34,03>, gbreak::ext , cntrls::non_control            },  // 317
            { widths::vs<34,13>, gbreak::ext , cntrls::non_control            },  // 318
            { widths::vs<34,23>, gbreak::ext , cntrls::non_control            },  // 319
            { widths::vs<34,33>, gbreak::ext , cntrls::non_control            },  // 320
            { widths::vs<44,03>, gbreak::ext , cntrls::non_control            },  // 321
            { widths::vs<44,13>, gbreak::ext , cntrls::non_control            },  // 322
            { widths::vs<44,23>, gbreak::ext , cntrls::non_control            },  // 323
            { widths::vs<44,33>, gbreak::ext , cntrls::non_control            },  // 324
            { widths::vs<44,43>, gbreak::ext , cntrls::non_control            },  // 325
            { widths::vs<14,04>, gbreak::ctrl, cntrls::non_control            },  // 326
            { widths::vs<14,14>, gbreak::ctrl, cntrls::non_control            },  // 327
            { widths::vs<24,04>, gbreak::ctrl, cntrls::non_control            },  // 328
            { widths::vs<24,14>, gbreak::ctrl, cntrls::non_control            },  // 329
            { widths::vs<24,24>, gbreak::ctrl, cntrls::non_control            },  // 330
            { widths::vs<34,04>, gbreak::ctrl, cntrls::non_control            },  // 331
            { widths::vs<34,14>, gbreak::ctrl, cntrls::non_control            },  // 332
            { widths::vs<34,24>, gbreak::ctrl, cntrls::non_control            },  // 333
            { widths::vs<34,34>, gbreak::ctrl, cntrls::non_control            },  // 334
            { widths::vs<44,04>, gbreak::ctrl, cntrls::non_control            },  // 335
            { widths::vs<44,14>, gbreak::ctrl, cntrls::non_control            },  // 336
            { widths::vs<44,24>, gbreak::ctrl, cntrls::non_control            },  // 337
            { widths::vs<44,34>, gbreak::ctrl, cntrls::non_control            },  // 338
            { widths::vs<44,44>, gbreak::ctrl, cntrls::non_control            },  // 339
        });
    };
