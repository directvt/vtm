...
CATEGORY = { 'Uppercase_Letter'      : 'Lu',  # an uppercase letter
             ...
             'Surrogate'             : 'Cs',  # a surrogate codepoint
             'Private_Use'           : 'Co',  # a private-use character
             'Unassigned'            : 'Cn',  # a reserved unassigned codepoint or a noncharacter
 ...
 * Properties of a single Unicode character are accessed by its codepoint value.
 *
 * Format conventions
