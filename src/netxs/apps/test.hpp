...
namespace netxs::events::userland
{
    namespace test
    {
        static constexpr auto _root = netxs::events::type_clue<netxs::events::userland::seed::parent, netxs::utf::cat("app::test::events"), netxs::events::userland::seed::custom.id>{};
        EVENTPACK( _root )
        {
