...
For compatibility with the `win32-input-mode` protocol, the non-BMP codepoints of the string could be split into surrogate halves (two 16-bit code units) and sent unit-by-unit in successive events.
