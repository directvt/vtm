...
- Keyboard
  ```
  ESC [ VirtCode ; ScanCode ; UniCode ; KeyState ; CtrlState ; RepeatCount ; KeyCode ; C1 ; … ; Cn _
  ```
- Viewport
  ```
...
Function keys have `UniCode` = 0, and set `C1`, ..., `Cn` containing the generated VT-string.
- Keystroke <kbd>LeftArrow</kbd> generates string `C1=27; C2=91; C3=68` = `←[D`
- Keystroke <kbd>Ctrl+LeftArrow</kbd> generates string `C1=27; C2=91; C3=49; C4=53; C5=126` = `←[1;5D`
- Keystroke <kbd>F5</kbd> generates string `C1=27; C2=91; C3=49; C4=53; C5=126` = `←[15~`
- Keystroke <kbd>Shift+F5</kbd> generates string `C1=27; C2=91; C3=49; C4=53; C5=59; C6=50; C7=126` = `←[15;2~`.
...
Each key has a unique `KeyCode` which maps to `VirtCode`, `ScanCode` and the `CtrlState` flag. The string generated by the keystroke is not included in this mapping because it depends on modifiers state and the national keyboard layout.

KeyCode | Physical Key                  | VirtCode     | ScanCode     | CtrlState    | Notes
--------|-------------------------------|--------------|--------------|--------------|-------------
