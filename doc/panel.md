...
App-based content sources for the panel:

- [`A panel for vtm`](https://github.com/vosjedev/vtm-panel) by [vosjedev](https://vosjedev.pii.at/) for live view of your system resources:
  - username@hostname
  - RAM usage
  - CPU usage
  - Battery status
