...
Here you can specify which command will continuously generate the panel content and its size. The content for the panel can be any console output, be it generated by a script, by a console application, or by something else. All emitted control sequences will be processed at the [VT-100](https://invisible-island.net/xterm/ctlseqs/ctlseqs.html) level. Note that vtm will be automatically disconnected when the connected source ends.
